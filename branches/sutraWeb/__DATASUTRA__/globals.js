...
function DS_router(p1,params,itemID,launch,logout,pathName) {
	...
	//helper function to unbase64 (for referrer)
	function atob(input) {
		var output = "";
		var chr1, chr2, chr3 = "";
		...
		if (base64test.exec(input)) {
			application.output("There were invalid base64 characters in the input text.\n" +
...
//			url.referrer = decodeURIComponent(escape(atob(params[item])))
